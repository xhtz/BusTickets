...
public class BajajActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bajaj");
    ...
    public void registerBajaj(View view){
        if(LoginActivity.agentGroup.equalsIgnoreCase("Client") && !tinydb.getString("loginStatus").equalsIgnoreCase("logged_in")){
            dialogMessage("Ingia kwanza kwenye akaunti yako au jisajili kama mtumiaji ndipo usajili bajaj");
        }
        else
        {
            Intent intent = new Intent(getApplicationContext(), RegisterBajajActivity.class);
            startActivity(intent);
        }
    }
    public void searchBajaj(View view){
        Intent intent = new Intent(getApplicationContext(), SearchBajajActivity.class);
        startActivity(intent);
    }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try
                {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(BajajActivity.this);
                    String message = "";
                    if(days.equalsIgnoreCase("0"))
                    {
                        message += "Muda wa kuonekana kwa abiria umekwisha. Unataka kulipia bajaj "+regNumber+"?";
                    }
                    else
                    {
                        message += "Zimebaki siku "+days+" za kuonekana kwa abiria. Unataka kulipia bajaj  "+regNumber+"?";
                    }
                ...
                {
                    Toast.makeText(BajajActivity.this, "Jaribu tena tafadhari", Toast.LENGTH_LONG).show();
                }
    ...
    private class PostClass extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progress.setMessage("Tunakusanya orodha ya bajaj zako....");
            progress.show();
        }
        ...
        protected String doInBackground(String... params)
        {
            try
            {
                ...
                String urlParameters            = "user_id="+tinydb.getString("appUserId")+"&&driverCategory=Bajaj";
