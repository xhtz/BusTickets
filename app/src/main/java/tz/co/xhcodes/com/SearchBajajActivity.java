...
public class SearchBajajActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Tafuta Bajaj");
        setContentView(R.layout.activity_search_bajaj);
        ...
        if(ContextCompat.checkSelfPermission(SearchBajajActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
        {
            ActivityCompat.requestPermissions(SearchBajajActivity.this, new String[]{Manifest.permission.CALL_PHONE}, 111);
        }
        bodaActions(drivers_list_view);
    }
    @Override
    public void onBackPressed() {
        Intent intent = new Intent(getApplicationContext(), BajajActivity.class);
        ...
        switch (requestCode) {
            case 111: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(SearchBajajActivity.this, "Permission enabled", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(SearchBajajActivity.this, "Huwezi kupiga simu moja kwa moja kwa dereva", Toast.LENGTH_LONG).show();
                }
                return;
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try
                {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SearchBajajActivity.this);
                    String message = "";
                ...
                {
                    Toast.makeText(SearchBajajActivity.this, "Jaribu tena tafadhari", Toast.LENGTH_LONG).show();
                }
    ...
    private class PostClass extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progress.setMessage("Tunakusanya orodha ya bajaj....");
            progress.show();
        }
        ...
        protected String doInBackground(String... params)
        {
            try
            {
                ...
                String urlParameters            = "user_id="+tinyDB.getString("appUserId")+"&&driverCategory=Bajaj&&search_term="+search_term+"&&town_id="+town_id;
            ...
            else
            {
                try
                {
                    ...
                    if(!tinyDB.getString("townid").equalsIgnoreCase(""))
                    {
                        ...
                        new PostClass(SearchBajajActivity.this).execute();
                    }
                }
                catch (JSONException e)
                {
