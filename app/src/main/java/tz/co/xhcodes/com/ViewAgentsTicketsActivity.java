...
public class ViewAgentsTicketsActivity extends AppCompatActivity {
    String POST_URL     = Config.baseUrl+"index.php/tickets/getAgentTickets";
    ...
    private class PostClass extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            try
            {
                ...
                String urlParameters            = "timetable_id="+BusVariables.timetableId+"&&company_id="+BusVariables.companyId+"&&agentId="+LoginActivity.agentId+"&&bus_agent_level="+LoginActivity.bus_agent_level+"&&konda="+LoginActivity.konda;
    ...
    void dialogMessage(String msg){
        AlertDialog.Builder builder = new AlertDialog.Builder(ViewAgentsTicketsActivity.this);
