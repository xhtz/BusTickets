...
public class ViewAgentCollectionsActivity extends AppCompatActivity {
    String POST_URL     = Config.baseUrl+"index.php/tickets/getIwachuAgentCollections";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewagent_collections);
        ...
        fromDateBox         = findViewById(R.id.chooseDateBox);
    ...
    public void searchCollections(View view){
        ...
        if(!fromDate.equalsIgnoreCase("") && !toDate.equalsIgnoreCase("")){
            new PostClass(ViewAgentCollectionsActivity.this).execute();
        }
        else
        {
    ...
    void dialogMessage(String msg){
        AlertDialog.Builder builder = new AlertDialog.Builder(ViewAgentCollectionsActivity.this);
