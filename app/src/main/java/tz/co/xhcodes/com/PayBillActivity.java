...
public class PayBillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etCompanyNumber = (EditText)findViewById(R.id.client_number_box);
        etRefNumber     = (EditText)findViewById(R.id.reference_number_box);
        etAmount        = (EditText)findViewById(R.id.amount_paid_box);
        etPrintButton   = (Button)findViewById(R.id.printReceipt);
    ...
    private class PostClass extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            try
            {
                ...
                String urlParameters            = "clientCode="+clientCode+"&&agentCode="+LoginActivity.agentCode+"&&refNumber="+refNumber+"&&amount="+amount;
