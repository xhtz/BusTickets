...
public class BusTicketAgentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Calendar c;
    private int mYear;
    private int mMonth;
    private int mDay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_ticket_agent);
        selectCompany   = (Spinner)findViewById(R.id.selectCompanySpinner);
        selectRoute     = (Spinner)findViewById(R.id.selectRouteSpinner);
       ...
       // AlarmManager am = (AlarmManager) this.getSystemService(Context.ALARM_SERVICE);
        ...
        selectRoute.setOnItemSelectedListener(this);
        new PostGetCompaniesClass(this).execute();
        new PostGetRoutesClass(this).execute();
    ...
    public void searchBusesTimetable(View view)
    {
        ...
        if(recordDate.length()>0)
        {
            ...
            Intent intent = new Intent(BusTicketAgentActivity.this, BusesListActivity.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
        ...
        if(spinner.getId() == R.id.selectRouteSpinner)
        {
            route_id = myRoutesList.get(position).get("routeid");
            //Toast.makeText(BusTicketAgentActivity.this, route_id, Toast.LENGTH_LONG).show();
        }
    }
    ...
    private class PostGetCompaniesClass extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String result)
        {
            ...
            {
                dialogMessage("Hakuna orodha iliyopatikana");
            }
            else
            {
                try
    ...
    void dialogMessage(String msg){
        AlertDialog.Builder builder = new AlertDialog.Builder(BusTicketAgentActivity.this);
