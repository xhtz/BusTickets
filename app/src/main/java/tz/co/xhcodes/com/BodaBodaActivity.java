...
public class BodaBodaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boda_boda);
    ...
    public void registerBodaBoda(View view){
        if(LoginActivity.agentGroup.equalsIgnoreCase("Client") && !tinydb.getString("loginStatus").equalsIgnoreCase("logged_in")){
            ...
            Intent intent = new Intent(getApplicationContext(), RegisterBodaBodaActivity.class);
            startActivity(intent);
        }
    }
    public void searchBodaBoda(View view){
        Intent intent = new Intent(getApplicationContext(), SearchBodaBodaActivity.class);
        startActivity(intent);
    }
    private void bodaActions(final ListView listView){
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try
                {
                    ...
                    final String feeAmount         = driver.feeAmount;
                       ...
                       String message = "";
                        ...
                        {
                            message += "Muda wa kuonekana kwa abiria umekwisha. Unataka kulipia boda boda "+regNumber+"?";
                        }
                        else
                        {
                            message += "Zimebaki siku "+days+" za kuonekana kwa abiria. Unataka kulipia boda boda  "+regNumber+"?";
                        }
                ...
                {
                    Toast.makeText(BodaBodaActivity.this, "Jaribu tena tafadhari", Toast.LENGTH_LONG).show();
                }
    ...
    private class PostClass extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progress.setMessage("Tunakusanya orodha ya boda boda zako....");
            progress.show();
        }
        ...
        protected String doInBackground(String... params)
        {
            try
            {
                ...
                String urlParameters            = "user_id="+tinydb.getString("appUserId")+"&&driverCategory=Boda";
