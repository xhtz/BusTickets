...
public class SearchTaxiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(SearchTaxiActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
        {
            ActivityCompat.requestPermissions(SearchTaxiActivity.this, new String[]{Manifest.permission.CALL_PHONE}, 111);
        }
        ...
        switch (requestCode) {
            case 111: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(SearchTaxiActivity.this, "Permission enabled", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(SearchTaxiActivity.this, "Huwezi kupiga simu moja kwa moja kwa dereva", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    private void bodaActions(final ListView listView){
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(SearchTaxiActivity.this, "Jaribu tena tafadhari", Toast.LENGTH_LONG).show();
                }
    ...
    private class PostClass extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progress.setMessage("Tunakusanya orodha ya taxi....");
            progress.show();
        }
        ...
        protected String doInBackground(String... params)
        {
            try
            {
                ...
                String urlParameters            = "user_id="+tinyDB.getString("appUserId")+"&&driverCategory=Taxi&&search_term="+search_term+"&&town_id="+town_id;
            ...
            else
            {
                try
                {
                    ...
                    if(!tinyDB.getString("townid").equalsIgnoreCase(""))
                    {
                        ...
                        new PostClass(SearchTaxiActivity.this).execute();
                    }
                }
                catch (JSONException e)
                {
